...
function gpg_import()
{
	...
	if ! gpg2 --batch --quiet --edit-key 34C589A7 check clean cross-certify save quit > /dev/null 2>&1; then
	...
	if ! gpg2 --batch --quiet --edit-key 65558117 check clean cross-certify save quit > /dev/null 2>&1; then
