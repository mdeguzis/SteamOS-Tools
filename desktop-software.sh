...
function gpg_import()
{
	...
	if ! gpg2 --batch --quiet --edit-key 8106E72834C589A7 check clean cross-certify save quit > /dev/null 2>&1; then
	...
	if ! gpg2 --batch --quiet --edit-key 5C808C2B65558117 check clean cross-certify save quit > /dev/null 2>&1; then
