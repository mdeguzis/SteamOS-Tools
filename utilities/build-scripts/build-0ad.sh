...
# Scipt Name:	build-0ad.sh
# Script Ver:	0.1.1
# Description:	Attempts to build a deb package from 0ad git source
#
# See:		https://github.com/0ad/0ad
...
# upstream URL
git_url="https://github.com/jp9000/0ad"
